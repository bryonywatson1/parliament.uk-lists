...
RSpec.describe People::Associations::GroupedBy::OppositionController, vcr: true do
  describe "GET index" do
    ...
    it 'assigns @person, @seat_incumbencies, @opposition_incumbencies, @current_party_membership,
    ...
    it 'adds opposition roles to history' do
      ...
      methods = [
          {
            ...
            data_url: "#{ENV['PARLIAMENT_BASE_URL']}/person_associations_grouped_by_opposition?person_id=7KNGxTli"
          }
        ]
