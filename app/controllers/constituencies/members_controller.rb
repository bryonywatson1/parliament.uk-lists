module Constituencies
  class MembersController < ApplicationController
    ...
    def index
      @constituency, @seat_incumbencies = FilterHelper.filter(@request, 'ConstituencyGroup', 'SeatIncumbency')
    ...
    def current
      @constituency, @seat_incumbency = FilterHelper.filter(@request, 'ConstituencyGroup', 'SeatIncumbency')
      @constituency = @constituency.first
