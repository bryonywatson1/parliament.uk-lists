module Parliaments
  class MembersController < ApplicationController
    ...
    def index
      @parliament, @people, @letters = FilterHelper.filter_letters(@request, 'ParliamentPeriod', 'Person')
    ...
    def a_to_z
      @parliament, @letters = FilterHelper.filter_letters(@request, 'ParliamentPeriod')
      @parliament = @parliament.first
      @letters    = @letters.map(&:value)
      @all_path = :parliament_members_path
    end
